...
(function (root, factory) {
  ...
  function css(t, free) {
    ...
    return [
      ...
      /* ★箱の 幅は いつも 同じ★（2026-09-10 司さん
           「考えれる 長い 振込先も 1行で 入れる 幅に ★背景のボックスを デフォルトに しとけ★」）
         ★前は 中身なり★＝短い 口座だと 箱が 小さく、会社ごとに 顔が 変わっていた。
         ★実測（2026-09-10）★ 世の中で いちばん長い 部類
           「青森県信用組合 十和田支店 普通 1234567 カ）トウホクソウゴウケンセツコウギョウ」
           … 本文 7.5pt・口座番号 13pt で ★418px★
           使える 幅 … 罫線ありの 紙 455px／控除の 紙 556px
         ⇒ ★112mm（≒423px）★を 最低の 幅に する（418px＋少しの 余裕）。
         ★長い 時は そのまま 伸びる★（width:auto）＝切れない。 */
      '.note-b.note-bb{width:auto;min-width:112mm;min-height:24px;font-size:7.5pt;white-space:nowrap;}',
