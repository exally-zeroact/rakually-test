...
(function (root, factory) {
  ...
  var TEMPLATES = {
    ...
    /* ★4つ目＝すきま自動★（2026-09-08 司さん
       「赤丸の隙間を 自動で調整する版の これも テンプレに 加えといたら
         細々した調整も いらんやろ？」）
       ＝★列も 見た目も std1 と 同じ★／違うのは ★空行を 埋めない★ 事だけ。
       明細が 1行の 月でも 表の下に 大きな 空白が 出ない＝
       ★会社が 毎回 行数を いじらなくて よい★。 */
    slim: {
      id: 'slim',
      label: '品名・数量・単価（すきま自動）',
      note: '列は いちばん上と 同じ。明細が 少ない月は 空行を 出さず、'
        + '表の下の すきまが 自動で 詰まります。行数の 調整が いりません。',
      cols: {
        items: ['#', '品名・内容', '数量', '単位', '単価', '金額', '消費税'],
        widths: { '#': 28, '品名・内容': 220, '数量': 56, '単位': 44, '単価': 80, '金額': 100, '消費税': 72 },
        aligns: {},
      ...
      theme: {
        ...
        band: '#F0FAF4', headBg: '#F2F2F2', headInk: '#333333', grandInk: '#333333',
        rule: 'rows', titleSpacing: '.32em', grandGo: 'ご',
        memoBox: false,
        itemSum: '項目の合計',
        sumsHead: '差引請求額',
        sumsHeadPlain: '合計金額',
        /* ★これが この様式の 中身★＝空行を 埋めない */
        autoRows: true,
      },
    },
    ...
    genba: {
      ...
      cols: {
        ...
        /* ★備考を 広げた★（2026-09-09 司さん「備考欄の幅をもう少し広げて」）
           ...
           備考が 折り返さない事を 優先した。 */
        widths: { '項目': 150, '数量': 46, '単位': 40, '金額': 92, '消費税': 62, '備考': 210 },
        aligns: {},
      },
      theme: {
        ink: '#333333', sub: '#6B6B6B', line: '#B0B0B0', accent: '#B0B0B0',
