...
- ~~給与は `exally.vercel.app/kyuyo/` に間借りしたまま。今回は動かしません。~~
  **★2026-09-19 この行は古い★** … `091002e`（2026-09-05）で **Exally から外し済み**。
  **実測 2026-09-19 03:23Z** … `rakually.vercel.app/kyuyo/` ＝ **200 OK**（本番の倉庫を指す）／
  `exally.vercel.app/kyuyo/` ＝ **404**。**給与は もう Rakunally に在ります**。
