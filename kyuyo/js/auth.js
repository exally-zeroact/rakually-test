...
(function(){
  ...
  var LOGIN = window.RakuallyLogin.mount({
    app: '給与',
  ...
  function jpErr(s){ if(window.RakuallyLogin) return RakuallyLogin.friendly({message:s});
  ...
  function showLock(){
    ...
    ov.innerHTML='<div class="auth-card"><div class="auth-logo">Rakually</div>'
