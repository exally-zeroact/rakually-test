...
(function(){
  ...
  var LOGIN = window.RakunallyLogin.mount({
    app: '給与',
  ...
  function jpErr(s){ if(window.RakunallyLogin) return RakunallyLogin.friendly({message:s});
  ...
  function showLock(){
    ...
    ov.innerHTML='<div class="auth-card"><div class="auth-logo">Rakunally</div>'
