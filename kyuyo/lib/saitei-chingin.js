 ...
 * 【参照先】厚生労働省『令和8年度 地域別最低賃金 答申状況』(2026-09-03 答申)
 *   https://www.mhlw.go.jp/content/11302000/001745621.pdf
 *   ★一覧ページ(.../minimumichiran/)を 指すな★＝2026-09-12 に 実際に 取って 数えたら
 *     「1,280」0回・「1,177」0回・「令和8年度」0回＝★出典を 開いても 確かめられない★
 *   ★出典は SOURCE_URL（下）に 1つだけ 持つ★＝ops も 中央も そこから 取る（手で 書かない）
 * 【最終確認】令和8年度（2026年10月1日〜12月2日 順次発効・★発効日は 予定★）
 * 全国加重平均：1,177円（前年 1,121円・+56円）
 * 最高 東京 1,280円／最低 宮崎 1,085円
 *   ★この頭の 数字も 古くなる★＝疑ったら ★NENDO_YEAR / ZENKOKU_HEIKIN / todofuken を 見る★（そこが 正）
 * ================================================================
 * 【更新方法】
...
const SAITEI_CHINGIN = {
  ...
  /* ★出典は ここ 1か所★（2026-09-12・経営者1が 3か所に 手書きされている事を 見つけた）
     ops の 札も 中央へ 送る行も ★ここから 取る★＝手で 書くと ★片方だけ 古くなる★ */
  SOURCE_URL: 'https://www.mhlw.go.jp/content/11302000/001745621.pdf',
