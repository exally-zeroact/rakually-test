...
export const ALLOWED = {
  ...
  'scripts/_souko-ref.mjs':
    '★「どっちが本番か」の答えを持つ1枚★（2026-09-14 新設）。見張りが「この repo は どっち側か」を'
    + '突き合わせる為に 両方の ref が 要る。★走る物を1行も置かない＝import しても何も起きない★'
    + '（check-warehouse-pointers から借りたら ★import だけで本体が走った★ので分けた）。'
    + '★他の道具はここから借りる＝直書きを増やさない★',
};
